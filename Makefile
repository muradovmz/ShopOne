...
publish_pacts:
	@echo "\n========== STAGE: publish pacts ==========\n"
	@"${PACT_CLI}" publish ${PWD}/PactTests/pacts --consumer-app-version ${GIT_COMMIT} --branch ${GIT_BRANCH}
...
create_or_update_github_commit_status_webhook:
	@"${PACT_CLI}" \
	  ...
	  'https://api.github.com/repos/muradovmz/ShopOne/statuses/$${pactbroker.consumerVersionNumber}' \
